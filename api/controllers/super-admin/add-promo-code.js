...
module.exports = {
  ...
  fn: async function (inputs, exits) {
    sails.log("calling action super-admin/add-promo-code");
    let temp = inputs;
    delete temp.image;
    sails.log(temp);
    let exist = await Promo_code.find({
    ...
    try {
      ...
      sails.log(`Error in action super-admin/add-promo-code. ${err}`);
      return exits.ok({
        status: false,
